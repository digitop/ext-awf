...
<svg fill="{{ $fill }}" class="{{ $class }}" version="1.1" id="{{ $id }}" xmlns="http://www.w3.org/2000/svg"
     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40.032 47.032" xml:space="preserve"><g
